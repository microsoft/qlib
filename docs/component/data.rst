...
- User download data and converting data into data (with filename suffix `.bin`) in Qlib format.  In this step, typically only some basic data is stored on disk(such as OHLCV). 
