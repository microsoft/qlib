...
class TestPIT(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        GetData().qlib_data(name="qlib_data_simple", target_dir=cn_data_dir, region="cn",  exists_skip=True)
        GetData().qlib_data(name="qlib_data", target_dir=pit_dir, region="pit",  exists_skip=True)
