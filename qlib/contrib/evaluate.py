...
from .strategy import TopkAmountStrategy, TopkWeightStrategy
...
def get_strategy(
    ...
    str_type: 'amount' or 'weight'
        strategy type: TopkAmountStrategy or  TopkWeightStrategy
    ...
    if strategy is None:
        ...
        if str_type == "amount":
            str_cls = TopkAmountStrategy
        elif str_type == "weight":
            str_cls = TopkWeightStrategy
        else:
