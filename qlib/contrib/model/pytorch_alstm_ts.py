...
class ALSTM(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.logger.info(f"model size: {count_parameters(self.ALSTM_model):.4f} MB")
...
class ALSTMModel(nn.Module):
    ...
    def _build_model(self):
        try:
            ...
            raise ValueError(f"unknown rnn_type `{self}`".rnn_type) from e
