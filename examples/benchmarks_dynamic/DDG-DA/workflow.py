...
class DDGDABench(DDGDA):
    ...
    def __init__(
        self, conf_path: Union[str, Path] = DEFAULT_CONF, horizon=20, *, trusted: bool = False, **kwargs
    ) -> None:
        # This code is for being compatible with the previous old code
        conf_path = Path(conf_path)
        super().__init__(conf_path=conf_path, horizon=horizon, working_dir=DIRNAME, trusted=trusted, **kwargs)
