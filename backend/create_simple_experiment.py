...
# Create a very simple experiment that should run quickly
simple_config = {
    "task": {
        "model": {
            "class": "LinearModel",
...
simple_experiment = Experiment(
    ...
    description="A simple test experiment to verify the performance calculation fix",
...
print(f"Created simple experiment with ID: {experiment_id}")
