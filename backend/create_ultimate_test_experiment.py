...
simple_experiment = Experiment(
    name="Ultimate Test Experiment",
    description="A final test experiment to verify the performance calculation fix with proper date formatting",
...
print(f"Created ultimate test experiment with ID: {experiment_id}")
