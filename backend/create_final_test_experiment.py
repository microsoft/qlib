...
simple_experiment = Experiment(
    name="Final Test Experiment",
    description="A final test experiment to verify the performance calculation fix",
...
print(f"Created final test experiment with ID: {experiment_id}")
